...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/task-management-system/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Applications/XAMPP/xamppfiles/htdocs/task-management-system/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'profile.destroy','tasks.index','tasks.create','tasks.store','tasks.show',
'tasks.edit','tasks.update','tasks.destroy','register',
